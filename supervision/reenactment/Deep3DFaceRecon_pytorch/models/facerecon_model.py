...
from Deep3DFaceRecon_pytorch.util.preprocess import estimate_norm_torch
...
class FaceReconModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        # parser.add_argument('--bfm_folder', type=str, default='/apdcephfs_cq2/share_1290939/branchwang/py_projects/PIRender/Deep3DFaceRecon_pytorch/BFM')
        parser.add_argument('--bfm_folder', type=str,
                            default='Deep3DFaceRecon_pytorch/checkpoints/PIRender/Deep3DFaceRecon_pytorch/BFM')
