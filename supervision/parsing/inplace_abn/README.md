# Update
## [2022/7/15] Compat to Different GPU Architecture
...
Refer to [NVIDIA](https://docs.nvidia.com/datacenter/tesla/drivers/index.html#software-matrix)
to find the compat GPU **arch**itecture:
