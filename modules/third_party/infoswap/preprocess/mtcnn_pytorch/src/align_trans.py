...
from infoswap.preprocess.mtcnn_pytorch.src.matlab_cp2tform import get_similarity_transform_for_cv2
...
def warp_and_crop_face(src_img,
                       ...
                       return_trans_inv=False, mode=None):
    """
    Function:
    ----------
    ...
    if crop_size[0] == 96 and crop_size[1] == 112:
        ref_pts[:, 0] = (ref_pts[:, 0] - crop_size[0] / 2) * 0.85 + crop_size[0] / 2
        ref_pts[:, 1] = (ref_pts[:, 1] - crop_size[1] / 2) * 0.85 + crop_size[1] / 2
    else:
