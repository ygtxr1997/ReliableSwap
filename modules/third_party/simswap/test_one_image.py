...
if __name__ == '__main__':
    """
    python test_one_image.py --name people --Arc_path arcface_model/arcface_checkpoint.tar --pic_a_path infer_images/target.jpg --pic_b_path infer_images/source.jpg --output_path infer_images/
    """
    ...
    with torch.no_grad():
        ...
        cv2.imwrite(os.path.join(opt.output_path + 'result.jpg'),output)