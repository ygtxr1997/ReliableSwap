...
from faceshifter_pl import FaceshifterPL512


"""
Usage:
python faceshifter_finetune512.py  \
    --name triplet512_11  \
    --no-finetune  \
    -bs 4  
"""
...
parser.add_argument("--no-finetune", action='store_true', help="If with, close finetune mode. (default: false)")
...
use_finetune = not args.no_finetune
faceshifter = FaceshifterPL512(
